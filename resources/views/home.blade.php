				...
				<div class="col-lg-9 offset-lg-2 text-center">
					<div class="hero-text">
						<div class="hero-text-tablecell">
							{{-- <p class="subtitle">pppp</p> --}}
							<h1>(Heal)ang</h1>
							<div class="hero-btns">
								{{-- <a href="shop.html" class="boxed-btn">Pengaduan</a> --}}
			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="section-title">	
						<h3><span class="orange-text">News</span> Lost and Found</h3>
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-12">
					<div class="abt-text">
						...
						<h2>We are <span class="orange-text">(Heal)ang</span></h2>
